...
public class Parameters {
     ...
     */
    public static double alpha = 1.35;
     ...
     */
    public static double antPopSize = 0.8;

    /**
     * Size of nearest neighbor list for each vertex
     */
    public static int NNSize = 100;

    /**
     * Number of iterations to find a good solution
     */
    public static int iterationsMax = 3000;

    public static int numOfCities = 280;
